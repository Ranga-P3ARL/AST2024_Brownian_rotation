...
omega_1t=omega_1_0*exp(c1*t);
omega_2t=omega_2_0*exp(c2*t);
omega_3t=omega_3_0*exp(c3*t);
...
psieA=psieA*(180/pi);
  ...
  if mod(i+1,skip)==0 %printing values
    ...
    oomega_1t(nn,:)=omega_1t;
    oomega_2t(nn,:)=omega_2t;
    oomega_3t(nn,:)=omega_3t;
    ...
    writematrix(oomega_1t,'ana_ang_vel_x.txt');
    writematrix(oomega_2t,'ana_ang_vel_y.txt');
    writematrix(oomega_3t,'ana_ang_vel_z.txt');
